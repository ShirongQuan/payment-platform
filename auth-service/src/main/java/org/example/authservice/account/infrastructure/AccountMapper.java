...
public class AccountMapper {
  ...
  /**
   * Rehydrates a {@link Account} domain object from a managed {@link AccountEntity}.
   * Used when business logic needs to operate on a loaded entity inside a transaction.
   */
