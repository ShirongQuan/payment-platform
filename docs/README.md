...
- [Accounting Model](./domain/accounting-model.md)
- [Payment State Machine](./domain/state-machine.md)

## 2) Core design

- [Data Model / ERD](./data/data-model.md)
- [Outbox & Eventing](./eventing/outbox-pattern.md)
- [Kafka Topics](./eventing/kafka-topics.md)
- [Concurrency & Consistency](./reliability/concurrency-consistency.md)

## 3) Operability

- [Resilience Patterns](./reliability/resilience-patterns.md)
- [Observability Index](./observability/README.md)
- [Telemetry](./observability/telemetry.md)
- [Runbook](./observability/runbook.md)
- [Alerts and SLOs](./observability/alerts-slos.md)
